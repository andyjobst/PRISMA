# -----------------------------  
# Automated literature search for Elsevier-SCOPUS, PRISMA Part 1, 13 May 2025 (c) Andreas (Andy) Jobst, aaj22@cam.ac.uk
...
# -----------------------------  
api_key <- "2cd48ad4c32d99e6c9fbfd57251b8a96"  
base_url <- "https://api.elsevier.com/content/search/scopus"  

# -----------------------------    
# Define initial thematic query  
query_string <- "TITLE-ABS-KEY((infrastructure*) AND (financ* OR invest* OR capital OR lend*) AND (insurance OR insurer OR pension) AND (regulat* OR prudential OR restrict*)) AND PUBYEAR > 1980 AND PUBYEAR < 2026"  
# -----------------------------  

# -----------------------------  
# Define terms for auto-screening based on relevance  
auto_screen_terms <- c("infrastructure", "finance", "investment", "insurance")  
# -----------------------------  
  
# -----------------------------  
# Function to process a single SCOPUS record with additional fields  
# -----------------------------  
...
# -----------------------------  
# Specification of function for rate-limited API requests to SCOPUS using exponential back-off
# -----------------------------  
...
# -----------------------------  
# Creat relevance, auto_screen and inclusion variables   
# -----------------------------  
