# -----------------------------  
# Automated literature search for Elsevier-SCOPUS, PRISMA Part 2, 13 May 2025 (c) Andreas (Andy) Jobst, aaj22@cam.ac.uk
...
# Load data
# -----------------------------  
df <- read.csv("scopus_results_raw.csv", encoding = "UTF-8")  
...
eligible_df <- eligible_df %>%  
  mutate(theme = case_when(  
    ...
    str_detect(tolower(Title), "green|sustainable|sustainability") ~ "Sustainability",  
    TRUE ~ "Other"  
  ))  
